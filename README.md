...
---
## 🎯 Focus
- Explainable AI (XAI) — SHAP, LIME, and interpretable model design
- Deep Learning — CNNs, autoencoders, PyTorch-based model training
- Generative AI — LLM-based tools, RAG pipelines, prompt engineering
- Applied ML — turning research-grade models into usable, real-world applications
---
## 🛠️ Tech & Tools
**Languages:** Python, C#, JavaScript, SQL
**AI / ML:** PyTorch, TensorFlow, Scikit-learn, XGBoost, SHAP, LIME
**Generative AI:** RAG pipelines, Prompt Engineering, LLM-based tooling
**App Development:** PyQt5, Streamlit, SQLite
**Design:** Graphic Design (Adobe tools)
**Other:** Git/GitHub, Data Analysis, Feature Engineering, Arduino/IoT
---
## 📜 Certifications
